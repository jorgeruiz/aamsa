...
const services = [
  {
    ...
    title: "Corte Láser",
    description:
      "Alta precisión en corte de lámina y placa de acero. Tolerancias estrictas, acabados de calidad en series medianas y grandes.",
  ...
  },
  {
    ...
    description: "Para placa gruesa. Control numérico garantiza repetibilidad en alto volumen.",
  ...
  },
  {
    ...
    title: "Doblez CNC",
    description: "Ángulos exactos, radios controlados y dimensiones reproducibles en cada pieza.",
    spec: "Hasta 6m longitud",
  ...
  },
  {
    ...
    description: "Velocidad y economía para grandes formatos. Producción de blancos en serie.",
    spec: "Lámina hasta 10mm",
  ...
  },
  {
    ...
    title: "Pantógrafo",
    description: "Piezas de geometría irregular. Opción económica para prototipos y lotes pequeños.",
    spec: "Formatos irregulares",
  ...
  },
  {
    ...
    image: "/rolado.png",
    title: "Rolado",
    description: "Formado curvo de lámina, placa y perfiles. Arcos, cilindros y formas cónicas.",
    spec: "Perfiles y tubería",
