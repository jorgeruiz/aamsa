    ...
    <section className="relative py-24 lg:py-32 bg-[#1B4375] overflow-hidden">
      ...
      <div className="relative max-w-[1440px] mx-auto px-6 lg:px-10">
        ...
        <MotionSection className="mb-20 max-w-4xl">
          ...
          <p
            className="font-[family-name:var(--font-inter)] text-lg md:text-xl lg:text-2xl text-white/90 leading-relaxed max-w-3xl"
          >
            <span className="text-[#FF7F00] font-bold">720 Paneles solares</span>{" "}
            forman parte de nuestro compromiso por reducir el impacto ambiental de
            nuestras operaciones y avanzar hacia una industria más sustentable.
          </p>
        </MotionSection>
